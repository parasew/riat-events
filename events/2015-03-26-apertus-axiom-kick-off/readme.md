...
- http://eu.axiom-camera.com/
  - https://web.archive.org/web/20170419101627/http://eu.axiom-camera.com/
  - Description (source): The AXIOM Gamma is an open-technology camera system built around a modular hardware concept, designed to be extendable, repairable, and sustainable over time.
