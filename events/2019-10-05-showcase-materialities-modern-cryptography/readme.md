...
- Closely related official program entry exists under Open Hardware Month:
  - "Open Hardware and Decentralized Communities" (event text explicitly references HCPP and RIAT sessions).
- HCPP 2019 conference site corroborates venue/timeframe context.

## Resources
- RIAT archive index (this repository):
  - https://github.com/parasew/riat-events/blob/master/archive/README.md
- Open Hardware Month event page (archived copy):
